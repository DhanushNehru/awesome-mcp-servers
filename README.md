...
- [AISOTools MCP](https://aisotools.com/mcp) - Remote server for searching, comparing, and finding alternatives across a curated catalog of 1,400+ AI tools in 21 categories. Remote endpoint, no API key.
